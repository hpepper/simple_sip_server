...
public:
    ...
    void test_DisectMessage()
    {
        std::string message = "REGISTER sip:example.com SIP/2.0\r\nTo: sip:801@example.com\r\nFrom: sip:801@example.com\r\nCall-ID: f81d4fae-7dec-11d0-a765-00a0c91e6bf6@example.com\r\nCSeq: 0 REGISTER\r\nExpires: 3600\r\nContent-Length: 0\r\n\r\n";
        SipMessageRegister *psipMessage = new SipMessageRegister(message);
        int status = psipMessage->DisectMessage();
        TS_ASSERT_EQUALS("TODO", "REGISTER");
